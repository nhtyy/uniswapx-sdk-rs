...
pub mod mock_fee_controller {
    ...
    impl<M> ::core::fmt::Debug for MockFeeController<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(stringify!(MockFeeController)).field(&self.address()).finish()
        }
    }
