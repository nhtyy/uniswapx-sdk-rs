...
pub mod exclusivity_override_lib {
    #[rustfmt::skip]
    const __ABI: &str = "[{\"inputs\":[],\"type\":\"error\",\"name\":\"NoExclusiveOverride\",\"outputs\":[]}]";
    ///The parsed JSON ABI of the contract.
    pub static EXCLUSIVITYOVERRIDELIB_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    ...
    pub static EXCLUSIVITYOVERRIDELIB_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __BYTECODE,
    );
    #[rustfmt::skip]
    ...
    pub static EXCLUSIVITYOVERRIDELIB_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __DEPLOYED_BYTECODE,
    );
    ...
    impl<M> ::core::fmt::Debug for ExclusivityOverrideLib<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(stringify!(ExclusivityOverrideLib))
                .field(&self.address())
                .finish()
        }
    }
